  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col h-screen fixed left-0 top-0">
      <div className="p-6 flex items-center gap-3">
        ...
        <span className="font-bold text-white text-lg">MedGemma</span>
      </div>
      ...
      <div className="p-6 border-t border-slate-800">
        <div className="bg-slate-800 rounded-lg p-3">
          <p className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-2">Privacy Guard</p>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
            <span className="text-xs text-slate-300">HIPAA Compliant Session</span>
          </div>
        </div>
      </div>
    </aside>
